...
<div class="bg-(--background-primary) p-4! rounded-2xl shadow-md shadow-slate-50/60">
    ...
    <div class="mobile flex bg-(--background-secondary) shadow-md shadow-slate-950/40 text-(--text-primary-dark)">
        <form action="?/add" class="addForm" method="POST" use:enhance>
            ...
            <div class="horizontal"><span class="bold">Nr.tel</span><span><input name="phoneNumber"
            ...
            <div class="horizontal"><span
                    class="bold">Komentarz</span><span><textarea class="shadow-md shadow-slate-950/40 border-0!"
                                                                 name="comment"></textarea></span></div>
    ...
    <div class="membersTable desktop">
        ...
        {#if showAddFragment}
            <form action="?/add" method="POST" use:enhance autocomplete="off"
                  class="addFragment text-(--text-primary-dark) bg-(--background-secondary) rounded-2xl! hover:bg-(--hover) hover:text-(--hover-foreground) duration-150 shadow-md shadow-slate-950/20 delay-75">
                <span class="data rounded-l-2xl"></span>
