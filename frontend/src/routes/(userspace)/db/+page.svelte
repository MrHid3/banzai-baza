	...
	<div class="mobile flex bg-(--background-secondary) shadow-md shadow-slate-950/40 text-(--text-primary-dark)">
		<form action="?/add" class="addForm" method="POST" use:enhance>
			...
			<div class="horizontal"><span
				class="bold">Komentarz</span><span><textarea class="shadow-md shadow-slate-950/40 border-0!" name="comment"></textarea></span></div>
			<div class="horizontal">
				<span></span>
				<button class="save text-(--text-primary) bg-(--click)" type="submit">Dodaj</button>
			</div>
		</form>
	</div>
	<div class="membersTable desktop">
		<div
			class="header desktop desktop text-(--text-primary-dark) bg-(--background-secondary) rounded-2xl! hover:bg-(--hover) hover:text-(--hover-foreground) duration-150 shadow-md shadow-slate-950/20 hover:-translate-y-1/12 delay-75">
			...
			<span class="data small rounded-r-2xl!">
		...
		{#if showAddFragment}
			<form action="?/add" method="POST" use:enhance autocomplete="off"
			      class="addFragment text-(--text-primary-dark) bg-(--background-secondary) rounded-2xl! hover:bg-(--hover) hover:text-(--hover-foreground) duration-150 shadow-md shadow-slate-950/20 hover:-translate-y-1/12 delay-75">
				<span class="data rounded-l-2xl"></span>
				<span class="data"><input type="text" name="name" class="input"></span>
				<span class="data"><input type="text" name="surname" class="input"></span>
